...
public class ForStmt extends Statement {
    ...
    private ArrayList<Statement> update = new ArrayList<>();
    ...
    public ArrayList<Statement> getUpdate() {
        return update;
    }

    public void setUpdate(ArrayList<Statement> update) {
        this.update = update;
    }

    public void addUpdate(Statement statement) {
        this.update.add(statement);
    }
